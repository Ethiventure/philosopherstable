...
export const CABINET_DEBTS: Record<string, CabinetDebt[]> = {
  ...
  marx: [
    ...
    { to: 'hegel', kind: 'direct', stance: 'critical', note: 'turned the dialectic right-side up: matter first, ideas second' },
  ...
  weil: [
    ...
    { to: 'marx', kind: 'direct', stance: 'critical', note: 'measured Marx against affliction — labour without grace is still force' },
  ...
  bookchin: [
    ...
    { to: 'kant', kind: 'direct', stance: 'critical', note: 'named Kant across EoF — the dualist foil (neo-Kantian mind-vs-nature), keeping only the moral imperative' },
  ...
  deleuze: [
    ...
    { to: 'kant', kind: 'direct', stance: 'critical', note: 'a whole book to overturn him: Kant’s Critical Philosophy' },
