...
export const PROVIDERS = {
  openrouter: { keyEnv: 'TEST_OPENROUTER_KEY', modelEnv: 'TEST_OPENROUTER_MODEL', defModel: 'deepseek/deepseek-v4.1-flash', url: 'https://openrouter.ai/api/v1/chat/completions', timeout: 60000, referer: true },
