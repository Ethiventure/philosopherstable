...
Next test (owner, Sep 20): GLM-5.3-flash at High, education question —
same keep rules (voice survives, no P2 echo, P3s with slogans +
why-better). 30B parked at High; Medium held by GLM.
- High: OPEN — nobody graded at High since prompts stabilized; winner of
  Medium gets the High sitting.
