...
| Sep 2026 | OpenRouter paid | `qwen/qwen3.8-flash` | NEXT CHEAP TEST (verified live Sep 16 2026: ID exists, $0.15/$0.47, 1M ctx, structured outputs, ~130 t/s but p50 TTFT ~4.6s). Same family as the 27B voice reference at ~1/6 the output price. Type into the paid-model box, grade Low obedience + voice. |
