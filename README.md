...
The shared key is one quota split across every visitor — a few sittings a day each, resetting at midnight UTC. (A full ten-seat table takes ~30 turns; the default five-seat sitting is about half that.) If the shared well runs dry, the cabinet pauses (nothing is lost) and offers one-click recovery:
